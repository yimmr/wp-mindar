...
$opts = array(
	...
	'roots' => array(
		array(
			...
			'path'       => getcwd().'../../../../file_manager',
			'startPath'  => getcwd().'../../../../file_manager',
			'URL'        => dirname($_SERVER['PHP_SELF']) . '/../../../file_manager/',
			...
			'uploadAllow' => array('application/octet-stream','model/gltf-binary','model/gltf','image/x-ms-bmp', 'image/gif', 'image/jpeg', 'image/png', 'image/x-icon', 'text/plain', 'text/x-php', 'application/zip', ), // Mimetype `image` and `text/plain` allowed to upload
		...
		array(
			...
			'uploadAllow'   => array('application/octet-stream','model/gltf-binary','model/gltf','image/x-ms-bmp', 'image/gif', 'image/jpeg', 'image/png', 'image/x-icon', 'text/plain', 'text/x-php', 'application/zip'), // Same as above
